...
def test_lists(subject):
    ...
    assert (
        ...
        == """call(<libyang.schema.Leaf: simplenonkey union>, 'non key value goes here', "'", True, default='non key value goes here', key=False, template=False, node_id="/testforms:toplevel/simplelist[simplekey='B']/simplenonkey")"""
    )
    assert (

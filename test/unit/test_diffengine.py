...
class test_diff_engine(unittest.TestCase):
    ...
    def test_diff_engine_modifies_the_adds(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ("/integrationtest:bronze", None, "", 1),
                ("/integrationtest:bronze/silver", None, "", 1),
                ("/integrationtest:bronze/silver/gold", None, "", 1),
                ("/integrationtest:bronze/silver/gold/platinum", None, "", 1),
        ...
        self.assertEqual(
            list(differ.modified()), [("/integrationtest:simpleleaf", "a", "b", 2)]
        )
        self.assertEqual(
            list(differ.remove()), [("/integrationtest:simpleenum", "A", None, 3)]
        )
        self.assertEqual(
            list(differ.add()),
            [
    ...
    def test_diff_engine_removes_then_modifies_the_adds(self):
        ...
        self.assertEqual(
            list(differ.remove_modify_then_add()),
            [
                ("/integrationtest:simpleenum", "A", None, 3),
                ("/integrationtest:simpleleaf", "a", "b", 2),
                ("/integrationtest:bronze", None, "", 1),
    ...
    def test_diff_engine_with_simpleleaf(self):
        ...
        # Assert
        self.assertEqual(
            list(differ.all()), [("/integrationtest:simpleleaf", "a", "b", 2)]
        )
    ...
    def test_diff_engine_with_simpleleaf_filtered(self):
        ...
        # Act
        differ = yangvoodoo.DiffEngine.DiffIterator(
            self.root_a, self.root_b, start_filter="/integrationtest:simplelist"
        )
    ...
    def test_diff_engine_with_leaflist_version_modify(self):
        ...
        # Act
        differ = yangvoodoo.DiffEngine.DiffIterator(
            self.root_a, self.root_b, start_filter="/integrationtest:morecomplex"
        )

        # Assert
        expected_results = [
            # with libyang stub leaf-lists are never modified they are always
            # treated independently.
            ("/integrationtest:morecomplex/leaflists/simple[.='E']", None, "E", 1),
            ("/integrationtest:morecomplex/leaflists/simple[.='e']", "e", None, 3),
        ]
    ...
    def test_diff_engine_with_leaflists(self):
        ...
        # Assert
        expected_results = [
            ("/integrationtest:morecomplex/leaflists/simple[.='A']", None, "A", 1),
            ("/integrationtest:morecomplex/leaflists/simple[.='C']", None, "C", 1),
            ("/integrationtest:morecomplex/leaflists/simple[.='a']", "a", None, 3),
            ("/integrationtest:morecomplex/leaflists/simple[.='c']", "c", None, 3),
            ("/integrationtest:morecomplex/leaflists/simple[.='d']", "d", None, 3),
            ("/integrationtest:morecomplex/leaflists/simple[.='e']", "e", None, 3),
        ]
        self.assertEqual(list(differ.all()), expected_results)
    ...
    def test_diff_engine_with_leaflists_justadd(self):
        ...
        # Assert
        expected_results = [
            ("/integrationtest:morecomplex", None, "", 1),
            ("/integrationtest:morecomplex/leaflists", None, "", 1),
            ("/integrationtest:morecomplex/leaflists/simple[.='A']", None, "A", 1),
        ]
        self.assertEqual(list(differ.all()), expected_results)
    ...
    def test_diff_engine(self):
        ...
        # Act
        differ = yangvoodoo.DiffEngine.DiffIterator(
            self.stub_a.dump_xpaths(),
            self.stub_b.dump_xpaths(),
            start_filter="/integrationtest:diff",
        )

        expected_results = [
            (
                "/integrationtest:diff/modifies/a-list[listkey='Lissie']/listnonkey",
                "earworm",
                "earworm!",
                2,
            ),
            ...
            (
                "/integrationtest:diff/modifies/a-2nd-leaf",
                "original value2",
                "new value2",
                2,
            ),
            ...
            (
                "/integrationtest:diff/adds/a-list[listkey='Ghouls']/listkey",
                None,
                "Ghouls",
                1,
            ),
            (
                "/integrationtest:diff/adds/a-list[listkey='Jim Lockey']/listkey",
                None,
                "Jim Lockey",
                1,
            ),
            ...
            (
                "/integrationtest:diff/deletes",
                "",
                None,
                3,
            ),
            (
                "/integrationtest:diff/deletes/a-list[listkey='Avril Lavigne']/listkey",
                "Avril Lavigne",
                None,
                3,
            ),
    ...
    def test_filter(self):
        self.assertFalse(
            yangvoodoo.DiffEngine.DiffIterator.is_filtered("start-----", "start", "")
        )
        self.assertFalse(
            yangvoodoo.DiffEngine.DiffIterator.is_filtered("------end", "", "end")
        )
        self.assertFalse(
            yangvoodoo.DiffEngine.DiffIterator.is_filtered(
                "start------end", "start", "end"
            )
        )
        self.assertTrue(
    ...
    def test_diff_engine_with_filtering_sent_in_later(self):
        ...
        self.assertEqual(
            list(differ.all(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_all,
        )
        self.assertEqual(
            list(differ.all(start_filter="/integrationtest:diff")),
    ...
    def test_diff_engine_with_filtering_sent_in_later(self):
        ...
        self.assertEqual(
            list(differ.modify_then_add(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_return_method,
        )
        ...
        self.assertEqual(
            list(differ.remove_modify_then_add(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_return_method,
        )
        ...
        self.assertEqual(
            list(differ.modified(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_return_method,
        )
        self.assertEqual(
            list(differ.modified(start_filter="/integrationtest:diff")),
        ...
        self.assertEqual(
            list(differ.add(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_return_method,
        )
        ...
        self.assertEqual(
            list(differ.remove(start_filter="/integrationtest:diff")),
            expected_results_when_filtering_on_return_method,
        )
    ...
    def test_diff_engine_with_filtering_sent_in_later_remove_modify(self):
        ...
        # Act
        differ = yangvoodoo.DiffEngine.DiffIterator(
            self.stub_a.dump_xpaths(), self.stub_b.dump_xpaths()
        )
        ...
        self.assertEqual(
            list(differ.remove_then_modify(start_filter="/integrationtest:diff")),
            expected_results_when_filtering,
        )
        self.assertEqual(
            list(differ.remove_then_modify(start_filter="/integrationtest:diff")),

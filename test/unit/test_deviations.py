...
import unittest
import yangvoodoo
from yangvoodoo.Errors import NodeAlreadyProvidedCannotChangeSchemaError, ValueDoesMatchEnumeration
...
class test_deviations(unittest.TestCase):
    ...
    def test_load_module_with_deviations(self):
        ...
        self.assertFalse('to_make_not_supported' in dir(self.root.morecomplex.inner.deviant))

        with self.assertRaises(ValueDoesMatchEnumeration):
            self.root.morecomplex.inner.deviant.a_string = 'ThisShoudlBeRejectedBecauseOfTheDeviation'
    ...
    def test_load_module_without_deviations(self):
        ...
        self.assertTrue('to_make_not_supported' in dir(self.root.morecomplex.inner.deviant))

        self.root.morecomplex.inner.deviant.a_string = 'This is just a string becuase it is not deviated'

...
class test_stub_datastore(unittest.TestCase):
    ...
    def test_create(self):
        ...
        self.subject.add(
            "/integrationetest:morecomplex/integrationtest:leaflists/integrationtest:simple",
            "ABC",
            10,
        )
        self.subject.add(
        ...
        self.subject.set(
            "/integrationtest:underscoretests/integrationtest:underscore_only", "A", 10
        )
        ...
        self.assertEqual(
            list(
                self.subject.gets_sorted(
                    "/integrationtest:simplelist", "/integrationtest:simplelist"
                )
            ),
            expected_result,
        )

...
class test_common(unittest.TestCase):
    ...
    def test_convert_path_to_schema_path(self):
        result = Utils.test_convert_path_to_schema_path("/path/abc/def[g='sdf']/xyz/sdf[fdsf='fg']/zzz", 'module')
        ...
        result = Utils.test_convert_path_to_schema_path("/path/abc/def[g='sdf']", 'module')
        expected_result = ("/module:path/module:abc/module:def", "/module:path/module:abc")
        self.assertEqual(result, expected_result)

        result = Utils.test_convert_path_to_schema_path("/path/abc", 'module')
    ...
    def test_convert_path_to_value_path(self):
        result = Utils.test_convert_path_to_value_path("/path/abc/def[g='sdf']/xyz/sdf[fdsf='fg'][hhhh='hh']/zzz", 'module')
        expected_result = ("/module:path/abc/def[g='sdf']/xyz/sdf[fdsf='fg'][hhhh='hh']/zzz", "/module:path/abc/def[g='sdf']/xyz/sdf")

        self.assertEqual(result, expected_result)

        result = Utils.test_convert_path_to_value_path("/path/abc/def[g='sdf'][h='sdf']/sdsd", 'module')
        expected_result = ("/module:path/abc/def[g='sdf'][h='sdf']/sdsd", '/module:path/abc/def')
        self.assertEqual(result, expected_result)

        result = Utils.test_convert_path_to_value_path("/path/abc", 'module')
